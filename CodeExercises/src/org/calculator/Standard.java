...
public class Standard extends Automobile{
	...
	public String toString(){
		return "Standard Automobile by "+getmName()+" with vin " +getVin()+ " is available to rent in " +getColor()+ " color. This beast has a range of " +getRange()+ " and only costs $" +getcost();
	}
