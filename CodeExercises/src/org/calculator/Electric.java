...
public class Electric extends Automobile {
	...
	public String toString(){
		return "Electric Automobile by "+getmName()+" with vin " +getVin()+ " is available to rent in " +getColor()+ " color. The monster has a range of " +getRange()+ " and only costs $" +getcost()+ "unless range exceeded";
	}
