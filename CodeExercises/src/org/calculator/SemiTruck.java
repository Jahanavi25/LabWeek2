...
public class SemiTruck extends Diesel {
	...
	public String toString(){
		return "SemiTruck Automobile by "+getmName()+" with vin " +getVin()+ " is available to rent in " +getColor()+ " color. The monster has a range of " +getRange()+ " and only costs $" +getcost()+ "unless range exceeded";
	}
